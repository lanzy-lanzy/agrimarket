# Generated by Django 5.1.1 on 2025-05-13 23:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(limit_choices_to={'is_buyer': True}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Item',
            fields=[
                ...
                ('category', models.CharField(choices=[('livestock', 'Livestock'), ('poultry', 'Poultry')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='marketplace.cart')),
            ],
        ),
        migrations.CreateModel(
            name='Sale',
